...
namespace CSPawt
{
    ...
    public class ActiveButton : Button, IamCSProcess
    {
    /**
     ...
     */
    public ActiveButton(String s) : this(null, null, s)
    {
     ...
     */
    public ActiveButton(ChannelInput configure, ChannelOutput channelEvent) :this(configure,  channelEvent, "")
    {
     ...
     * @param s the initial label displayed on the button.
     */
    public ActiveButton(ChannelInput configure, ChannelOutput channelEvent, String s) : super(s)
    {
        ...
        {
            ActionEventHandler handler = new ActionEventHandler(channelEvent);
     ...
     */
    public void addEventChannel(ChannelOutput channelEvent)
    {
        if (channelEvent != null)
        {
            ActionEventHandler handler = new ActionEventHandler(channelEvent);
