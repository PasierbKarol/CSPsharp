...
namespace CSPnet2.NetChannels
{
    ...
    public interface NetChannelEndFactory
    {
        ...
        /*public*/
        NetChannelOutput one2net(NetChannelLocation loc);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NetChannelLocation loc);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NetChannelLocation loc, int immunityLevel);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NetChannelLocation loc, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NetChannelLocation loc, int immunityLevel, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetChannelOutput one2net(NodeID nodeID, int vcn, int immunityLevel, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeID nodeID, int vcn);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeID nodeID, int vcn, int immunityLevel);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeID nodeID, int vcn, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeID nodeID, int vcn, int immunityLevel, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetChannelOutput one2net(NodeAddress nodeAddr, int vcn);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetChannelOutput one2net(NodeAddress nodeAddr, int vcn, NetworkMessageFilter.FilterTx filter);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeAddress nodeAddr, int vcn);
        ...
        /// <exception cref="JCSPNetworkException">some scenario</exception>
        /*public*/
        NetSharedChannelOutput any2net(NodeAddress nodeAddr, int vcn, NetworkMessageFilter.FilterTx filter);
