...
namespace CSPnet2.NetChannels
{
    ...
    public sealed class StandardNetChannelEndFactory : NetChannelEndFactory
    {
         ...
         */
        public NetChannelOutput createOne2Net(NetChannelLocation loc) //TODO should that throw an exception when it cannot be created?
        ////throws JCSPNetworkException
        {
         ...
         *             Thrown if something goes wrong in the underlying architecture
         */
        public NetSharedChannelOutput createAny2Net(NetChannelLocation loc) //TODO should that throw an exception when it cannot be created?
        ////throws JCSPNetworkException
        {
         ...
         */
        public NetAltingChannelInput numberedNet2One(int index) //TODO should that throw an exception when it cannot be created?
        // //throws ArgumentException 
        {
            return Net2OneChannel.create(index, Int32.MaxValue, new ObjectNetworkMessageFilter.FilterRX());
        }
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetAltingChannelInput numberedNet2One(int index, int immunityLevel) //TODO should that throw an exception when it cannot be created?
        ////throws ArgumentException 
        {
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetAltingChannelInput numberedNet2One(int index, NetworkMessageFilter.FilterRx filter) //TODO should that throw an exception when it cannot be created?
        ////throws ArgumentException 
        {
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetAltingChannelInput numberedNet2One(int index, int immunityLevel, NetworkMessageFilter.FilterRx filter) //TODO should that throw an exception when it cannot be created?
        ////throws ArgumentException 
        {
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetSharedChannelInput numberedNet2Any(int index) //TODO should that throw an exception when it cannot be created?
        // //throws ArgumentException 
        {
            return Net2AnyChannel.create(index, Int32.MaxValue, new ObjectNetworkMessageFilter.FilterRX());
        }
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetSharedChannelInput numberedNet2Any(int index, int immunityLevel) //TODO should that throw an exception when it cannot be created?
        ////throws ArgumentException 
        {
         ...
         *             Thrown if a channel with the given index already exists
         */
        public NetSharedChannelInput numberedNet2Any(int index, NetworkMessageFilter.FilterRx filter) //TODO should that throw an exception when it cannot be created?
        ////throws ArgumentException 
        {
         ...
         *             Thrown if a channel with the given index already exists.
         */
        public NetSharedChannelInput numberedNet2Any(int index, int immunityLevel, NetworkMessageFilter.FilterRx filter) //TODO should that throw an exception when it cannot be created?
        //throws ArgumentException 
        {
         ...
         *             Thrown if something goes wrong in the underlying architecture
         */
        public NetChannelOutput one2net(NetChannelLocation loc) //TODO should that throw an exception when it cannot be created?
        //throws JCSPNetworkException
        {
            return One2NetChannel.create(loc, Int32.MaxValue, new ObjectNetworkMessageFilter.FilterTX());
        }
         ...
         *             Thrown if something goes wrong in the underlying architecture
         */
        public NetChannelOutput one2net(NetChannelLocation loc, int immunityLevel) //TODO should that throw an exception when it cannot be created?
        //throws JCSPNetworkException
        {
         ...
         *             Thrown if something goes wrong in the underlying architecture
         */
        public NetChannelOutput one2net(NetChannelLocation loc, NetworkMessageFilter.FilterTx filter) //TODO should that throw an exception when it cannot be created?
        //throws JCSPNetworkException
        {
