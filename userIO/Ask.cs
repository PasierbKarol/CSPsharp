...
//            public readonly Boolean isNumber;
...
//            public Prompt(String label, int min, int max, int def) {
//                this.label = label;
//                this.min = min;
//                this.max = max;
//                this.def = def;
...
//            if (p == null) throw new Exception("oops: " + prompt);
//            return p.value;
//        }
...
//            One2OneChannel frameEvent = Channel.one2one(new
//                OverWritingBuffer(1));
//            One2OneChannel frameConfig = Channel.one2one(new
//                OverWritingBuffer(1));
//            One2OneChannel okEvent = Channel.one2one(new
//                OverWritingBuffer(1));
//            One2OneChannel okConfig = Channel.one2one(new
//                OverWritingBuffer(1));
//            One2OneChannel cancelEvent = Channel.one2one(new
//                OverWritingBuffer(1));
//            One2OneChannel cancelConfig = Channel.one2one(new
//                OverWritingBuffer(1));

//            ActiveFrame frame = new ActiveFrame(frameConfig.In(),
//                frameEvent.Out(), title);
//            ActiveButton ok = new ActiveButton(okConfig.In(), okEvent.Out(),
//            "Ok");
//            ActiveButton cancel = new ActiveButton(cancelConfig.In(),
...
//            frame.pack();
//            CSPParallel par = new CSPParallel(new IamCSProcess[]
//            {
//                frame,
//                ok,
//                cancel,
