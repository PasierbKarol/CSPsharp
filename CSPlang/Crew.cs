...
namespace CSPlang
{
     ...
     * CSPParallel processes must ensure controlled access to shared resources whose state can
     ...
     * <P>
     * CSPParallel <I>reader</I> operations on a resource do not lead to race hazards, so long as
     * no <I>writer</I> is present, and many applications need to be able to exploit this.
     * CSPParallel <I>writer</I> operations are always dangerous and must be suppressed.
