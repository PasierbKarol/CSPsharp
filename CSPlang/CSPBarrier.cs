...
namespace CSPlang
{
    ...
    public class CSPBarrier
    {
        ...
        */
        ...
        /**
         * The even/odd flag used to detect spurious wakeups. //TODO is it needed as there are no such wake-ups in .NET?
         */
        ...
        {
            //Debug.WriteLine("Called CSPBarrier from ParThread", "DEBUG");
            if (nEnrolled < 0)
            {
            ...
            countDown = nEnrolled;
            //Debug.WriteLine("CSPBarrier.constructor : " + nEnrolled + ", " + countDown, "DEBUG");
        }
        ...
        public void reset(/*final*/ int nEnrolled)
        {
            ...
            //Debug.WriteLine("CSPBarrier.reset : " + nEnrolled + ", " + countDown, "DEBUG");
        }
        ...
        public void sync()
        {
            //Debug.WriteLine("Before locking Barrier", "DEBUG");
            lock (barrierLock)
            {
                countDown--;
                //Debug.WriteLine("CSPBarrier.sync : " + nEnrolled + ", " + countDown, "DEBUG");
                if (countDown > 0)
                {
                    try
                    {
                        ...
                        while (spuriousCycle == evenOddCycle) //TODO is it still needed with no spurious wake-ups in .NET?
                        {
                            if (Spurious.logging)
                            {
        ...
        public void enroll()
        {
            ...
            //Debug.WriteLine("CSPBarrier.enroll : " + nEnrolled + ", " + countDown, "DEBUG");
        }
        ...
        public void resign()
        {
            lock (barrierLock)
            {
                nEnrolled--;
                countDown--;
                //Debug.WriteLine("CSPBarrier.resign : " + nEnrolled + ", " + countDown, "DEBUG");
                if (countDown == 0)
                {
                    countDown = nEnrolled;
                    evenOddCycle = !evenOddCycle;         // to detect spurious wakeups  :( //TODO is it still needed?
                    //Debug.WriteLine("CSPBarrier.resign : " + nEnrolled + ", " + countDown, "DEBUG");
                    Monitor.PulseAll(barrierLock);
                }
                else if (countDown < 0)
